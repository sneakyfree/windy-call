"""FastAPI dependencies for EPT-gated routes (Windy Call D.1).

D.1 keeps auth minimal — just `require_passport`. Tier-aware rate
limits + per-passport cost caps land in a future codon, mirroring
windy-search/app/auth/dependencies.py and reusing the same primitives
once the SMS path is proven end-to-end.
"""
